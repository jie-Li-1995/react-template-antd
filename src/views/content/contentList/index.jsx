...
export default class ContentList extends Component {
  ...
  createTip = (cityName, score, rangeGDP, rangeGCI, total) => {
    const color = '#e60012'
    const GDPText = '人均GDP'
      ...
      series: [
        {
          ...
          data: [
            { name: '沧州', value: 0 },
            { name: '北京', value: Math.random() * 1400 },
            { name: '天津', value: Math.random() * 1400 },
            { name: '上海', value: Math.random() * 1400 },
            { name: '重庆', value: Math.random() * 1400 },
            { name: '河北', value: Math.random() * 1400 },
            { name: '河南', value: Math.random() * 1400 },
            { name: '云南', value: Math.random() * 1400 },
            { name: '辽宁', value: Math.random() * 1400 },
            { name: '黑龙江', value: Math.random() * 1400 },
            { name: '湖南', value: Math.random() * 1400 },
            { name: '安徽', value: Math.random() * 1400 },
            { name: '山东', value: Math.random() * 1400 },
            { name: '新疆', value: Math.random() * 1400 },
            { name: '江苏', value: Math.random() * 1400 },
            { name: '浙江', value: Math.random() * 1400 },
            { name: '江西', value: Math.random() * 1400 },
            { name: '湖北', value: Math.random() * 1400 },
            { name: '广西', value: Math.random() * 1400 },
            { name: '甘肃', value: Math.random() * 1400 },
            { name: '山西', value: Math.random() * 1400 },
            { name: '内蒙古', value: Math.random() * 1400 },
            { name: '陕西', value: Math.random() * 1400 },
            { name: '吉林', value: Math.random() * 1400 },
            { name: '福建', value: Math.random() * 1400 },
            { name: '贵州', value: Math.random() * 1400 },
            { name: '广东', value: Math.random() * 1400 },
            { name: '青海', value: Math.random() * 1400 },
            { name: '西藏', value: Math.random() * 1400 },
            { name: '四川', value: Math.random() * 1400 },
            { name: '宁夏', value: Math.random() * 1400 },
            { name: '海南', value: Math.random() * 1400 },
            { name: '台湾', value: Math.random() * 1400 },
            { name: '香港', value: Math.random() * 1400 },
            { name: '澳门', value: Math.random() * 1400 }
          ]
        }
      ]
    })
